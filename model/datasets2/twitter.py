...
from datasets2.time_dataset import TimeDataset

DATA_PATH = "../MultiModalDataset"
EMBEDDINGS_PATH_TEXT = "embeddings_correct/twitter"
...
class TwitterDataset(TimeDataset):
    def __init__(self, args, kind="train"):
        ...
        print(len(positive_users), users_per_fold)
        ...
        with open("datasets2/twitter-dates.json", "rt") as f:
